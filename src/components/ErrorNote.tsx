...
// to know: amber is theirs or Luke's, rose is nobody's from here.
                ...
                <button
                  ...
                  className={
                    f.quiet
                      ...
                      : i === 0
                        ? "rounded-md bg-amber-600 px-2 py-1 text-[10px] font-semibold text-white transition-colors hover:bg-amber-700 disabled:opacity-50"
                        : "rounded-md border border-current/30 bg-white/70 px-2 py-1 text-[10px] font-medium transition-colors hover:bg-white disabled:opacity-50"
                  }
                >
                  {busy === i ? "…" : f.label}
                </button>
